...
import { Person, Facebook } from '@mui/icons-material'
...
const LoginModal = () => {
  ...
  return (
    <div className='register-modal w-[90%] h-[70vh] rounded-xl flex flex-col items-center justify-center'>
      ...
      <h2 className='font-bold text-4xl my-4 register-title'>Login</h2>
      ...
      <button onClick={handleLogin} className='w-full h-[45px] rounded-sm border-2 border-[#4285F4] flex items-center justify-between my-2'>
            ...
            <span className='bg-[#4285F4] w-[80%] h-full flex items-center justify-center text-white font-bold'>Login with google</span>
        </button>
        <button className='w-full h-[50px] rounded-sm border-2 border-black flex items-center justify-between my-2'>
            ...
            <span className='bg-white w-[80%] h-full flex items-center justify-center font-bold'>Login with Microsoft</span>
        </button>
        <button className='w-full h-[50px] rounded-sm border-2 border-[#4267B2] flex items-center justify-between my-2'>
            ...
            <span className='bg-[#4267B2] w-[80%] h-full flex items-center justify-center text-white font-bold'>Login with Facebook</span>
        </button>
      </div>
    </div> 
  )
